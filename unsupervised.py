...
VALIDATION_METRIC = 'mean_cosine-nn-S2T-10000'
...
parser.add_argument("--map_custom_init", type=str, default='default', help="Initialize the mapping as an custom matrix from the numpy file with suffix .npy")
...
src_emb, tgt_emb, mapping, src_weights, tgt_weights, discriminator = build_model(params, True) 
#trainer = Trainer(src_emb, tgt_emb, mapping, discriminator, params)
trainer = Trainer(src_emb, tgt_emb, mapping, src_weights, tgt_weights, discriminator, params)
    ...
    for n_epoch in range(params.n_epochs):
        ...
        for n_iter in range(0, params.epoch_size, params.batch_size):
            ...
            if n_iter % 500 == 0:
                ...
                logger.info(('%06i - ' % n_iter) + ' epoch' + ' - '.join(stats_log))
